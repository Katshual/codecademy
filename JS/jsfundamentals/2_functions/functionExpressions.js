/*
1. Let’s say we have a plant that we need to water once a week on Wednesdays. 
...
and if the plant needs to be watered:
    ...
    If the conditional is truthy, inside the if code block, 
    use the return keyword to return true.
...
*/
const plantNeedsWater=function waterDay(day){
    if(day==='Wednesday'){
      return true;
    }else {
      return false;
